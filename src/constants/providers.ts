...
export const PROVIDERS: {
  ...
  { id: "bailian", name: "Alibaba Bailian", baseURL: "https://dashscope.aliyuncs.com/compatible-mode/v1", keyUrl: "https://bailian.console.aliyun.com/", modelHint: "qwen3.5-plus" },
  ...
  { id: "zhipu", name: "Zhipu (GLM)", baseURL: "https://open.bigmodel.cn/api/paas/v4", keyUrl: "https://open.bigmodel.cn/usercenter/apikeys", modelHint: "glm-4-plus" },
  ...
  { id: "volcengine", name: "Volcengine (Doubao)", baseURL: "https://open.volcengineapi.com", keyUrl: "https://console.volcengine.com/iam/keymanage/" },
  ...
  { id: "ollama", name: "Ollama (local)", baseURL: "http://127.0.0.1:11434/v1", modelHint: "llama3.2" },
  { id: "vllm", name: "vLLM (local)", baseURL: "http://127.0.0.1:8000/v1" },
